...
% *
% */
function [ inpainted_img ] = RunCompleteMRF_efficient( Default, img, fgmask, FgSupidx, Predicted, MedSup, Sup, SupOri, TextSup,...
...
% =================================END OF Multiple Segmentation Occlusion Decision=====================================
  [ inpainted_img ] = ReportPlaneParaMRF_Conditioned( Default, img, fgmask, FgSupidx, Sup{1}, SupOri, full(Predicted.depthMap), zeros( size(Predicted.VarMap)), ...

...
% *
% */
function [] = RunCompleteMRF_efficient( Default, img, fgmask, Predicted, MedSup, Sup, SupOri, TextSup,...
...
% =================================END OF Multiple Segmentation Occlusion Decision=====================================
  ReportPlaneParaMRF_Conditioned( Default, fgmask, Sup{1}, SupOri, full(Predicted.depthMap), zeros( size(Predicted.VarMap)), ...

...
for Option = Select
    ...
    if Option == 1
       ...
       load(fullfile(Default.ParaFolder, 'Depth.mat'));
    ...
    elseif Option == 2
       ...
       load(fullfile(Default.ParaFolder, 'Var.mat'));
       ...
       load(fullfile(Default.ParaFolder, 'Ground.mat'));
       load(fullfile(Default.ParaFolder, 'Sky.mat'));
